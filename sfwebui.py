...
from osint import SpiderFootDb
from osint import SpiderFootHelpers
from osint import __version__
from osint.logger import logListenerSetup, logWorkerSetup
...
class SpiderFootWebUi:
    ...
    def error_page_404(self: 'SpiderFootWebUi', status: str, message: str, traceback: str, version: str) -> str:
        ...
        """
        templ = Template(filename='osint/templates/error.tmpl', lookup=self.lookup)
    ...
    def rerunscanmulti(self: 'SpiderFootWebUi', ids: str) -> str:
        ...
        templ = Template(filename='osint/templates/scanlist.tmpl', lookup=self.lookup)
    ...
    def newscan(self: 'SpiderFootWebUi') -> str:
        ...
        templ = Template(filename='osint/templates/newscan.tmpl', lookup=self.lookup)
    ...
    def scaninfo(self: 'SpiderFootWebUi', id: str) -> str:
        ...
        templ = Template(filename='osint/templates/scaninfo.tmpl', lookup=self.lookup, input_encoding='utf-8')
    ...
    def opts(self: 'SpiderFootWebUi', updated: str = None) -> str:
        ...
        """
        templ = Template(filename='osint/templates/opts.tmpl', lookup=self.lookup)
