...
# -------------------------------------------------------------------------------
# Name:         sf
# Purpose:      Main wrapper for calling all  modules
# -------------------------------------------------------------------------------
...
def start_web_server(sfWebUiConfig, sfConfig, loggingQueue=None):
    ...
    conf = {
        ...
        '/static': {
            ...
            'tools.staticdir.root': f"{sf.myPath()}/osint"
        }
    }
...
if __name__ == '__main__':
    ...
    if len(sys.argv) <= 1:
        print("This program requires -l <ip>:<port> to start the web server. Try --help for guidance.")
        sys.exit(-1)
    ...
    if os.path.exists('spiderfoot.db'):
        ...
        print("This program no longer supports loading the spiderfoot.db database from the application directory.")
    ...
    if os.path.exists('passwd'):
        ...
        print("This program no longer supports loading credentials from the application directory.")
